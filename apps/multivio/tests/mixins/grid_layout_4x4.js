...
module("Multivio.GridLayout4x4", {
  setup: function () {

    // create views for being laid out on the grid
    Multivio.testViews = SC.Page.design({
    ...
    v1 = Multivio.getPath('testViews.v1');
    v2 = Multivio.getPath('testViews.v2');
    v3 = Multivio.getPath('testViews.v3');
    v4 = Multivio.getPath('testViews.v4');
    v5 = Multivio.getPath('testViews.v5');
    v6 = Multivio.getPath('testViews.v6');
    v7 = Multivio.getPath('testViews.v7');
    v8 = Multivio.getPath('testViews.v8');
    ...
    SC.mixin(pane, Multivio.GridLayout4x4);
